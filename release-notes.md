...
## [1.29.0](https://github.com/equinor/data-modelling-storage-service/compare/@development-framework/data-modelling-storage-service-v1.28.3...@development-framework/data-modelling-storage-service-v1.29.0) (2026-03-03)
...
* add file support ([a5ed0b2](https://github.com/equinor/data-modelling-storage-service/commit/a5ed0b22b5ca5c74549cd64f8164db5c8bc92dd2))
* add new bdd scenario for create lookup test ([bcbe98b](https://github.com/equinor/data-modelling-storage-service/commit/bcbe98bd495c189edc1fae511369f50b6539c625))
...
* attribute endpoint ([8b1ab8f](https://github.com/equinor/data-modelling-storage-service/commit/8b1ab8f0f830a3ade7957ad3c5ff049e07af3e69))
* attribute-selector as default initial recipe ([2ec699a](https://github.com/equinor/data-modelling-storage-service/commit/2ec699a061b4bde8836a65e02c1e61aa3922873f))
...
* handle several package paths in create lookup use case ([48f8ace](https://github.com/equinor/data-modelling-storage-service/commit/48f8acea8d52a8e66bd73f5d716a262f3d6030e5))
...
* allow deletion of lists ([4f7339c](https://github.com/equinor/data-modelling-storage-service/commit/4f7339c75ae02bfa072b1333e910f6aba69c778b))
...
* avoid adding _id to reference dicts ([4e8fc36](https://github.com/equinor/data-modelling-storage-service/commit/4e8fc36552b0b6b8f4ac988c58aced2af50c99a8))
...
* bug with add document ([bd12053](https://github.com/equinor/data-modelling-storage-service/commit/bd12053ee60065d98299557fefa772f183eef715))
* bug with add document ([895f0b2](https://github.com/equinor/data-modelling-storage-service/commit/895f0b2c1a5d7ee49339c3febadff6c0b72cdf3b))
...
* bug with create entity ([2050738](https://github.com/equinor/data-modelling-storage-service/commit/2050738eed86e3a97ef9e9e9ed97a6cd494ad3b5))
...
* delete items in list ([fb644f4](https://github.com/equinor/data-modelling-storage-service/commit/fb644f4df0ff7c671fdb9e7a90bc75e2ecb6871b))
...
* document update bug ([6eca1fc](https://github.com/equinor/data-modelling-storage-service/commit/6eca1fcb890cd1b3d61f87597bf753aea26f90e1))
...
* handle more complex reference queries ([#439](https://github.com/equinor/data-modelling-storage-service/issues/439)) ([8c275ea](https://github.com/equinor/data-modelling-storage-service/commit/8c275eaf7f25454a55d35a17aa47c20c1d22de77))
...
* improve errors and typing ([23a4b04](https://github.com/equinor/data-modelling-storage-service/commit/23a4b0466ad0c87703445cecd3d693b865cab4f6)), closes [#389](https://github.com/equinor/data-modelling-storage-service/issues/389)
...
* let type of default in BlueprintAttribute be any ([8901faf](https://github.com/equinor/data-modelling-storage-service/commit/8901faf78e510a20b1df13fa3b3560f2a1becf44))
* linting ([3fb26ea](https://github.com/equinor/data-modelling-storage-service/commit/3fb26eafaa58d4cd5f294d9dba7adaef3bb3ffd4))
* ListNode missing 'set_uid' function ([fb84f0b](https://github.com/equinor/data-modelling-storage-service/commit/fb84f0b2a635eeac75b87db5f3724aebb633f5ba))
...
* make recipe plugin mandatory ([4c2e8dd](https://github.com/equinor/data-modelling-storage-service/commit/4c2e8ddd784efd8e211518ddf75fa8f13c246a4a))
...
* prevents user from deleting required attributes via document delete endpoint ([73bfe2c](https://github.com/equinor/data-modelling-storage-service/commit/73bfe2cd20b72bc299087b0d2b389d12c8d39c96))
...
* rename plugins according to new naming ([f082956](https://github.com/equinor/data-modelling-storage-service/commit/f0829569ab06003b1dcfdb0b071d6c2380d9f5f2))
* rename test-case to list ([3dc1b4e](https://github.com/equinor/data-modelling-storage-service/commit/3dc1b4e9121ca899be9a271570d2cc8b56e6a6fe))
...
* tests ([3fb26ea](https://github.com/equinor/data-modelling-storage-service/commit/3fb26eafaa58d4cd5f294d9dba7adaef3bb3ffd4))
...
* tree_node_from_dict() should not include optional attributes if not in the entity ([f899766](https://github.com/equinor/data-modelling-storage-service/commit/f899766010dba878a126348b9e6b9f39079f715e))
...
* update node list need to remove special symbol before compare to key ([51363ab](https://github.com/equinor/data-modelling-storage-service/commit/51363ab05c75a42a78cc24ff0324f62c5e4de921))
* update resolve_reference path with correct id ([aa4dff2](https://github.com/equinor/data-modelling-storage-service/commit/aa4dff2a09dde69b9a79e8506cc838113fe090ed))
...
* use new reference format in export endpoints ([8589cc6](https://github.com/equinor/data-modelling-storage-service/commit/8589cc6ba852498085968b282e24a584cfbdbf94))
...
* clean up _get_node_to_update() in document_service.py ([0dc273b](https://github.com/equinor/data-modelling-storage-service/commit/0dc273b786fe8857bd782e1fabce23344da2ba27))
...
* **master:** release 1.10.0 ([8968c2a](https://github.com/equinor/data-modelling-storage-service/commit/8968c2a1cc257b42d43b507b40fc8e4b538b0b57))
* **master:** release 1.11.0 ([1340294](https://github.com/equinor/data-modelling-storage-service/commit/13402941b3876f342932da7cf52dfed0c73d3b96))
* **master:** release 1.11.1 ([5acc2ef](https://github.com/equinor/data-modelling-storage-service/commit/5acc2efebf6ba01ee5d13b7c9ad346fcdfeb8ebb))
* **master:** release 1.11.2 ([490af50](https://github.com/equinor/data-modelling-storage-service/commit/490af504d507e0daca41ad76dd08c31116c5c6a7))
* **master:** release 1.12.0 ([3f03a09](https://github.com/equinor/data-modelling-storage-service/commit/3f03a090cd4c2a7e759f80bda2c4c065da53a1f3))
* **master:** release 1.13.0 ([716e398](https://github.com/equinor/data-modelling-storage-service/commit/716e3988b66d451fcee19dd5e08ee774c66e5a7f))
* **master:** release 1.14.0 ([0212c94](https://github.com/equinor/data-modelling-storage-service/commit/0212c94d1ae4cc679fa9096b9b7799e902148db0))
* **master:** release 1.14.1 ([9f5641f](https://github.com/equinor/data-modelling-storage-service/commit/9f5641fd3b77162ca642f5060f5f54702aed6d91))
* **master:** release 1.14.2 ([189c868](https://github.com/equinor/data-modelling-storage-service/commit/189c868d98453bec27402f56d8ddece4794b140c))
* **master:** release 1.14.3 ([97244da](https://github.com/equinor/data-modelling-storage-service/commit/97244dadd04e81bf8e81c1ad47eb4387d5d0d27d))
* **master:** release 1.15.0 ([d291675](https://github.com/equinor/data-modelling-storage-service/commit/d2916759189dd080db192649387e23dbcf10b70d))
* **master:** release 1.15.1 ([8380eeb](https://github.com/equinor/data-modelling-storage-service/commit/8380eeb57b9339d428c0dacc9b0a1dcc90f77a84))
* **master:** release 1.15.2 ([a7ff209](https://github.com/equinor/data-modelling-storage-service/commit/a7ff209480392164bbf7bbe96ee1536a1127a466))
* **master:** release 1.15.3 ([5e1f5df](https://github.com/equinor/data-modelling-storage-service/commit/5e1f5df13a80ea0f625a767ebf8bcbdac025e2e4))
* **master:** release 1.16.0 ([f8025f8](https://github.com/equinor/data-modelling-storage-service/commit/f8025f8730410df1d85e82088b6ee37410aaceb0))
* **master:** release 1.16.1 ([ca926dc](https://github.com/equinor/data-modelling-storage-service/commit/ca926dc06885581637fc4abed8094216b867321c))
* **master:** release 1.16.2 ([155b857](https://github.com/equinor/data-modelling-storage-service/commit/155b857a4220384592da5ec56f89107a8fad41ff))
* **master:** release 1.16.3 ([dfd5a03](https://github.com/equinor/data-modelling-storage-service/commit/dfd5a032e690e28fccf5d06fe3ad09e74d037fad))
* **master:** release 1.16.4 ([b20a34a](https://github.com/equinor/data-modelling-storage-service/commit/b20a34a527b1f137dd3e4e3b0ce57dddee5165b7))
* **master:** release 1.17.0 ([5a58687](https://github.com/equinor/data-modelling-storage-service/commit/5a586875d6a8b170a888887ee2a96cc057dea4a5))
* **master:** release 1.18.0 ([0f96550](https://github.com/equinor/data-modelling-storage-service/commit/0f96550a3f9a7004a2c1139c55968eba4218e3fd))
* **master:** release 1.18.1 ([e86aa72](https://github.com/equinor/data-modelling-storage-service/commit/e86aa725ec3a578b9a832dbb4600d28d2d2dfffe))
* **master:** release 1.18.2 ([6c5fb47](https://github.com/equinor/data-modelling-storage-service/commit/6c5fb4706969fac4996f81fb93da9b9ffdffdb0d))
* **master:** release 1.18.3 ([df85d3d](https://github.com/equinor/data-modelling-storage-service/commit/df85d3dab9ea1a4816f1beb0793a7a62a02c3dda))
* **master:** release 1.18.4 ([6c94a83](https://github.com/equinor/data-modelling-storage-service/commit/6c94a83191280a71c82a1fe151f7cdbadcab27de))
* **master:** release 1.18.5 ([3de103a](https://github.com/equinor/data-modelling-storage-service/commit/3de103a8a9a4c44a9f7256d56c5c4c8b25912ac9))
* **master:** release 1.19.0 ([f58f25b](https://github.com/equinor/data-modelling-storage-service/commit/f58f25b032ad5d7423ef10401c6f5d1d5d2ec27e))
* **master:** release 1.19.1 ([b05ef80](https://github.com/equinor/data-modelling-storage-service/commit/b05ef80c6dc50cc55fdc2f5f04727edb263524f6))
* **master:** release 1.20.0 ([32d1c42](https://github.com/equinor/data-modelling-storage-service/commit/32d1c42431e357949cda1b1415cfc1df817c2a59))
* **master:** release 1.20.1 ([22d9ceb](https://github.com/equinor/data-modelling-storage-service/commit/22d9cebb95e4ecfb833c80f0ddd26b51c8669df0))
* **master:** release 1.20.2 ([660feb2](https://github.com/equinor/data-modelling-storage-service/commit/660feb226b4277a093476e4748217c8805724cc6))
* **master:** release 1.21.0 ([c9ec01b](https://github.com/equinor/data-modelling-storage-service/commit/c9ec01b3a66cc7887d2298e5b75e4dad0e9b59e6))
* **master:** release 1.22.0 ([fea9d76](https://github.com/equinor/data-modelling-storage-service/commit/fea9d76faa3cf68974a0903514aae955042ea2a1))
* **master:** release 1.22.1 ([b079d01](https://github.com/equinor/data-modelling-storage-service/commit/b079d01f666765c846ba593b1836e3e309c1c781))
* **master:** release 1.23.0 ([3c0d8d3](https://github.com/equinor/data-modelling-storage-service/commit/3c0d8d32f96b5e0b6731da3cd98ec7a759431ad7))
* **master:** release 1.23.1 ([1171ac7](https://github.com/equinor/data-modelling-storage-service/commit/1171ac7b09b8a422e4407556aaea146b77c6bdc5))
* **master:** release 1.23.2 ([1a7cdf6](https://github.com/equinor/data-modelling-storage-service/commit/1a7cdf67f1994619151f6c0442dfabcadcc1b026))
* **master:** release 1.23.3 ([09c2153](https://github.com/equinor/data-modelling-storage-service/commit/09c2153a76ce601c19a2cb73b76a0060a43e5135))
* **master:** release 1.23.4 ([c41f410](https://github.com/equinor/data-modelling-storage-service/commit/c41f410c7a8f7e006e3126d50f81bc09b8a72685))
* **master:** release 1.24.0 ([29482b2](https://github.com/equinor/data-modelling-storage-service/commit/29482b23fc33fd8f28f68a3dad1c912675496996))
* **master:** release 1.25.0 ([07dc5da](https://github.com/equinor/data-modelling-storage-service/commit/07dc5daa1ce4b27b057ac056382533d9ff21bcc6))
* **master:** release 1.25.1 ([4fa05f5](https://github.com/equinor/data-modelling-storage-service/commit/4fa05f56b8d68a6e7a9c6c89d539d9ba164caaf9))
* **master:** release 1.25.2 ([ae44aa3](https://github.com/equinor/data-modelling-storage-service/commit/ae44aa3346c69757f4c496897a11e529b81cdca9))
* **master:** release 1.25.3 ([c97f287](https://github.com/equinor/data-modelling-storage-service/commit/c97f2878fe59f82f558e9bf5290e7f85073414d2))
* **master:** release 1.26.0 ([3ebf329](https://github.com/equinor/data-modelling-storage-service/commit/3ebf329e4acf674fcf84b7c83e7493236fce264d))
* **master:** release 1.27.0 ([d1d58fe](https://github.com/equinor/data-modelling-storage-service/commit/d1d58feeb296ace1f859865d8b1be9214cc809ee))
* **master:** release 1.27.1 ([06eb14d](https://github.com/equinor/data-modelling-storage-service/commit/06eb14de45afb83aa4f1992927f2f469db3808e2))
* **master:** release 1.28.0 ([0b41f3d](https://github.com/equinor/data-modelling-storage-service/commit/0b41f3dea6f80790aa7d8b8a66df7d8fd5b40241))
* **master:** release 1.28.0 ([3be55fc](https://github.com/equinor/data-modelling-storage-service/commit/3be55fc07470e5fceb1c81b8ecc926096d7c79eb))
* **master:** release 1.28.1 ([ee29485](https://github.com/equinor/data-modelling-storage-service/commit/ee29485242a9e1548185254a897365eca843f915))
* **master:** release 1.28.1 ([2a914f0](https://github.com/equinor/data-modelling-storage-service/commit/2a914f0082ba8fb0823552ff45658ff7eb5e467d))
* **master:** release 1.28.2 ([181a28e](https://github.com/equinor/data-modelling-storage-service/commit/181a28e0d29805739808a42e051716029c18a4cf))
* **master:** release 1.28.3 ([03cf7f8](https://github.com/equinor/data-modelling-storage-service/commit/03cf7f878a3937fd6925c1dcfd685f86dff54ec4))
* **master:** release 1.3.0 ([b7362dc](https://github.com/equinor/data-modelling-storage-service/commit/b7362dc211032746acbdd39f0b7bfaef9090e433))
* **master:** release 1.3.1 ([6f322a0](https://github.com/equinor/data-modelling-storage-service/commit/6f322a082769be058fb40894e5ba04d61fa4f4e8))
* **master:** release 1.4.0 ([04e50cf](https://github.com/equinor/data-modelling-storage-service/commit/04e50cfa58bd847c2693b0fa26dc44de61bcec7b))
* **master:** release 1.5.0 ([60ffa86](https://github.com/equinor/data-modelling-storage-service/commit/60ffa86fcc2e0530333701f4e9fb1510d6065a53))
* **master:** release 1.6.0 ([44c3286](https://github.com/equinor/data-modelling-storage-service/commit/44c3286a7b87d535d3d60c6e0663d99f11cc52b0))
* **master:** release 1.6.1 ([3596cff](https://github.com/equinor/data-modelling-storage-service/commit/3596cffb41e9ec405b21c95cc5708f525292f16d))
* **master:** release 1.6.2 ([9146553](https://github.com/equinor/data-modelling-storage-service/commit/914655393bc9a666b5ef101c0740a4b2f8871533))
* **master:** release 1.6.3 ([05b6f12](https://github.com/equinor/data-modelling-storage-service/commit/05b6f12dd5bb02127dd9a25626bd5d541df2dc1e))
* **master:** release 1.6.4 ([bc86a4e](https://github.com/equinor/data-modelling-storage-service/commit/bc86a4e717f97a4a1d8d14703935e2af7052e8f2))
* **master:** release 1.6.5 ([fc1a38d](https://github.com/equinor/data-modelling-storage-service/commit/fc1a38db990117a8995ef45332fd74910be19038))
* **master:** release 1.7.0 ([f19072a](https://github.com/equinor/data-modelling-storage-service/commit/f19072aa58b8abf365e92190790f7bb218fb860d))
* **master:** release 1.7.1 ([a831dc2](https://github.com/equinor/data-modelling-storage-service/commit/a831dc2e89966136bdad0c54daf1ee458b14ebd4))
* **master:** release 1.8.0 ([670ba75](https://github.com/equinor/data-modelling-storage-service/commit/670ba759ab1a1067fda657ddbfafb6f55f42742f))
* **master:** release 1.8.1 ([e1563fc](https://github.com/equinor/data-modelling-storage-service/commit/e1563fccece6d67834d92947beaf99ef5ced67b3))
* **master:** release 1.9.0 ([dd8befa](https://github.com/equinor/data-modelling-storage-service/commit/dd8befabe0ab1e30d3d2f602b896c379e29725e4))
...
* change to not found exception ([a68c256](https://github.com/equinor/data-modelling-storage-service/commit/a68c256a5a0b636044cdf7a947aa6d17e52cc7a6))
* cleanup testing of tree and also fix bug ([0470c11](https://github.com/equinor/data-modelling-storage-service/commit/0470c11d4c437855a5574008398b76201a2bf0c6))
...
* documentation and test coverage for ref_split ([a97dc76](https://github.com/equinor/data-modelling-storage-service/commit/a97dc7678217314fda3ca4ce1c9f569640790149))
...
* merge document add endpoints to one ([7dce62e](https://github.com/equinor/data-modelling-storage-service/commit/7dce62e5277522e6d1fa0c903f34c3b89ef4dfe3))
...
* remove redundant delete endpoint ([55e17c5](https://github.com/equinor/data-modelling-storage-service/commit/55e17c530563661347bd1ec54b9f4f0bc3bd600c))
...
* remove unused utils ([482490a](https://github.com/equinor/data-modelling-storage-service/commit/482490a169ded7c7c2da4c8733e04c69b8038d5c))
...
* rename is_same and rewrite queryitem ([baa4c49](https://github.com/equinor/data-modelling-storage-service/commit/baa4c4913f09e7fd228ac06f14bc164ea9ac0dde))
...
* rename recipe_package_paths argument in create_lookup endpoint ([325ad4f](https://github.com/equinor/data-modelling-storage-service/commit/325ad4f24050ad9c04cb158c035100d311305166))
* rename reference to path ([e981e99](https://github.com/equinor/data-modelling-storage-service/commit/e981e99e62d11775f78b5c59ad13a1bc4cf29edc))
...
* rename test_resolve_reference ([a94f55e](https://github.com/equinor/data-modelling-storage-service/commit/a94f55e3ae37d820de2339727259b145d8ee6bc5))
...
* replace reference str with Address class ([#457](https://github.com/equinor/data-modelling-storage-service/issues/457)) ([5ce26a7](https://github.com/equinor/data-modelling-storage-service/commit/5ce26a7de141a02387e556fd8ffbe5cbcce1a4db))
...
* set uid without checking if contained ([c6a915c](https://github.com/equinor/data-modelling-storage-service/commit/c6a915cd0566a78902ed11f40fadd023a4a0acab))
...
* simplify test_remove ([185fd46](https://github.com/equinor/data-modelling-storage-service/commit/185fd46fe4ffef775a4079fff9c68d543543db34))
...
* use poetery v2 ([bd5c25a](https://github.com/equinor/data-modelling-storage-service/commit/bd5c25aa340fff1e1fa7d647d507f2277ad2a760))
...
* make tests for resolve_reference ([a554e78](https://github.com/equinor/data-modelling-storage-service/commit/a554e789d5c1649df0cd6c4b90ab059e4f1918c6))
...
* remove duplicate get_document tests ([4910592](https://github.com/equinor/data-modelling-storage-service/commit/4910592bcd28f3d70d8f0b962df7d9c3a54fc841))
...
* restructure get_document tests ([71e76c0](https://github.com/equinor/data-modelling-storage-service/commit/71e76c01a1270b89e45069de8203238d9477a836))
...
* test invalid input to get_document ([d3d0a2a](https://github.com/equinor/data-modelling-storage-service/commit/d3d0a2ad8f9b9f34924bc86a3c704f1052ad8eb6)), closes [#389](https://github.com/equinor/data-modelling-storage-service/issues/389)
...
* **deps:** bump requests from 2.28.1 to 2.31.0 ([a0db624](https://github.com/equinor/data-modelling-storage-service/commit/a0db624d84e7bce6eb83df9acf4697998faa350c))
