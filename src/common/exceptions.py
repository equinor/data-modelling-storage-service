...
class ApplicationException(Exception):
    ...
    def __init__(self, message: str = "The requested operation failed",
                 debug: str = "An unknown and unhandled exception occurred in the API", data: dict = None,
                 status: int = 500, ):
        self.status = status
...
class MissingPrivilegeException(ApplicationException):
    def __init__(self, message: str = "You do not have the required permissions",
                 debug: str = "Action denied because of insufficient permissions", data: dict = None, ):
        self.type = self.__class__.__name__
        self.message = message
        self.debug = debug
        self.data = data
...
class NotFoundException(ApplicationException):
    def __init__(self, message: str = "The requested resource could not be found",
                 debug: str = "The requested resource could not be found", data: dict = None, ):
        self.type = self.__class__.__name__
        self.message = message
        self.debug = debug
        self.data = data
...
class BadRequestException(ApplicationException):
    def __init__(self, message: str = "Invalid data for the operation",
                 debug: str = "Unable to complete the requested operation with the given input values.", data: dict = None, ):
...
class ValidationException(ApplicationException):
    def __init__(self, message: str = "The received data is invalid",
                 debug: str = "Values are invalid for requested operation.", data: dict = None, ):
        super().__init__(message, debug, data)
        self.type = self.__class__.__name__
