...
class FindTestCase(unittest.TestCase):
    ...
    def test_when_dict(self):
        nested_dict = {
            "top": {
                "middle": {"nested": "value"},
                "list": [
                    {"top": {"middle": {"nested": "value 1"}}},
                    {"top": {"middle": {"nested": "value 2"}}},
                ],
        ...
        self.assertEqual(
            find(nested_dict, ["top", "list", "[0]", "top", "middle", "nested"]),
            "value 1",
        )
        self.assertEqual(
            find(nested_dict, ["top", "list", "[1]", "top", "middle", "nested"]),
            "value 2",
        )
    ...
    def test_when_list(self):
        ...
        self.assertEqual(
            find(
                list_of_nested_dicts,
                ["[0]", "top", "list", "[0]", "top", "middle", "nested"],
            ),
            "value 1",
        )
        self.assertEqual(
            find(
                list_of_nested_dicts,
                ["[0]", "top", "list", "[1]", "top", "middle", "nested"],
            ),
            "value 2",
        )
